...
class Solution:
    def validPath(self, n: int, edges: List[List[int]], source: int, destination: int) -> bool:
        self.adj_list = {i: [] for i in range(n)}  # create default adjacency list of vertices
        [[self.adj_list[u].append(v), self.adj_list[v].append(u)] for u, v in edges]  # create adjacency list of vertices, list comprehension
        ...
        #
        # self.adj_list = {i: [] for i in range(n)}  # create default adjacency list of vertices
        # for u, v in edges:  # create adjacency list of vertices
        #     self.adj_list[u].append(v)
        #     self.adj_list[v].append(u)
        #
        # def dfs(node, dest, visited):
        #     if self.path_exist == True:
        #         return
        #     if node == dest:
        ...
        #         if nxt not in visited:
        #             visited.add(nxt)
        #             dfs(nxt, dest, visited)
        #             #visited.remove(nxt)  not required as we are not checking all paths
        #
        # dfs(source, destination, set())
        #
